...
- `.gemini/sprite.yaml` config file (optional — uses defaults if missing)
...
5. **Promote wish to change**
   ...
   Generate in `wishes/<name>/`:
   - **proposal.md** — Why, What Changes, Capabilities, Impact
   - **design.md** — Approach, Components, File Structure
   - **tasks.md** — Checkbox breakdown of concrete tasks
...
7. **Implement the change**
   ...
   **Retry logic:**
   - If a task fails, try a different approach (up to 2 retries)
